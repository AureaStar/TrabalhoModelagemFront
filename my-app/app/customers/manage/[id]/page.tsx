...
// Funções auxiliares de formatação (fora do componente para não recriar a cada render)
...
export default function ManageCustomerPage() {
    ...
    // Estado para carregar o objeto original
    ...
    useEffect(() => {
        ...
        async function fetchCliente() {
            try {
                ...
                // Set initial values com formatação
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Validação simples de tamanho antes de enviar
        ...
        try {
            const payload = {
                instituicao,
                cnpj: cleanCNPJ, // Envia limpo para o banco
                telefone: cleanPhone, // Envia limpo para o banco
                status,
                responsavel,
                email,
                endereco
